...
<div align="center">
  ...
  <h1><b>Webpack Leaderboard - Microverse Project</b></h1>
...
# 📖 Webpack Leaderboard - Microverse Project <a name="about-project"></a>

**Webpack Leaderboard** is a milestone project for microverse student in JavaScript Module to learn about API
...
```sh
  git clone https://github.com/ichsansandy/leaderboard-microverse.git
```
